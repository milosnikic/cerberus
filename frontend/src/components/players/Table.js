          ...
          <div className="bg-white shadow-md rounded my-6">
            <div className="flex justify-center items-center p-5">
              <span className="font-large">
                There are no players for specified criteria
              </span>
            </div>
          </div>
        </div>
          ...
          <table className="min-w-max w-full table-fixed">
            <thead>
              <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                ...
                <th className="py-3 px-4 text-left w-230">
                  Email
                  <span
                ...
                <th className="py-3 px-2 text-left">Rating 2.0</th>
              </tr>
            </thead>
                ...
                return (
                  ...
                  >
                        ...
                        <div className="mr-2 flex items-center gap-2">
                          {player.nationality.map((nationality) => {
                            return (
                              <img
                                key={nationality.id}
                                className="w-8 h-6 rounded border border-gray-100"
                    ...
                    <td className="py-3 px-6 text-center">
                      <span className="border-gray-50 border py-1 px-3 bg-white rounded-full text-xs">
                        {player.age}
                      </span>
                    </td>
                    <td className="py-3 px-6 text-center">
                    ...
                    <td className="py-3 px-0">
                      <div className="flex justify-center gap-1">
                        {player.faceit && (
                          <a
                            href={`https://www.faceit.com/en/players/${player.faceit}`}
                            target="_blank"
                            rel="noreferrer"
                      ...
                      <div className="flex">
                        <div className="mr-2 text-ellipsis hover:scale-105">
                          <span
                            ...
                            className={`${
                              player.email
                                ? "hover:text-cyan-700 cursor-pointer"
                                : "text-red-500"
                            }`}
                          >
                    ...
                    <td className="py-3 px-3 text-left">
                      <span
                        className={`${
                          player.hltv_rating &&
                          `border-gray-50 border py-1 px-3 bg-white rounded-full ${getRatingColor(
                            player.hltv_rating
                          )}`
                        } text-xs`}
                      >
                        {player.hltv_rating || "N/A"}
                      </span>
                    </td>
                  </tr>
                );
