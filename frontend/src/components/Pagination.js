        ...
        <ol className="flex gap-4 text-xs font-medium items-center">
          <li>
            <button
              ...
              className={`inline-flex items-center justify-center w-8 h-8 border border-gray-100 rounded focus:outline-none ${
                !previous ? "not-allowed" : "cursor-pointer hover:bg-gray-50"
              }`}
            >
              <svg
          ...
          <li>
            <button
              ...
              className={`inline-flex items-center justify-center w-8 h-8 border border-gray-100 rounded focus:outline-none ${
                !next ? "not-allowed" : "cursor-pointer hover:bg-gray-50"
              }`}
              href=""
            >
              <svg
